...
public class PilotLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ans && !email_address.isEmpty() && !passwd.isEmpty()) {

                    final ProgressDialog progressDialog = new ProgressDialog(PilotLoginActivity.this);
                    ...
                    mAuth.signInWithEmailAndPassword(email_address, passwd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Intent intent = new Intent(getApplicationContext(), PilotProfileActivity.class);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(PilotLoginActivity.this, imageView);
                popupMenu.getMenuInflater().inflate(R.menu.except_signout_menu, popupMenu.getMenu());
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    @SuppressLint("WrongConstant")
                    @Override
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        Toast.makeText(PilotLoginActivity.this, menuItem.getTitle(), 0).show();
                        return true;
                    }
                });
                popupMenu.show();
